...
class VAE_main():
    ...
    def tabsyn_vae_main(self, dataname = 'adult', ckpt_dir='model', max_beta=1e-2, min_beta=1e-5, lambd=0.7, device = 'cpu', num_epochs = 10):
        ...
        pre_decoder = Decoder_model(self.NUM_LAYERS, d_numerical, categories, self.D_TOKEN, n_head = self.N_HEAD, factor = self.FACTOR).to(device)
