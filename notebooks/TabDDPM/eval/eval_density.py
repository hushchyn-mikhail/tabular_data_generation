...
if __name__ == '__main__':
    ...
    data_validity = diag_report.get_details('Data Validity')
    data_structure = diag_report.get_details('Data Structure')


    shapes.to_csv(f'{save_dir}/shape.csv')
    trends.to_csv(f'{save_dir}/trend.csv')
    # coverages.to_csv(f'{save_dir}/coverage.csv')
    data_validity.to_csv(f'{save_dir}/data_validity.csv')
    data_structure.to_csv(f'{save_dir}/data_structure.csv')
